...
export default function DetailedPrograms() {
  const programName = "Bachelor of Science in Business Administration - Human Resource Management";
  const formQuery = "/form?program=Bachelor of Science in Business Administration - Human Resource Management";
          ...
          <div>
            ...
            <div className="bg-white rounded-xl shadow-sm ring-1 ring-slate-200/30 p-8 border-l-4 border-blue-600">
              <p className="text-gray-700 text-lg leading-relaxed">
                The Bachelor of Science in Business Administration - Human Resource Management program provides comprehensive knowledge and skills in managing organizational human capital. Students will learn about recruitment, training, performance management, and employee relations.
              </p>
            </div>
          </div>
        </Reveal>
